...
<template>
    ...
    <Subsection title="Vorgehen">
      <InfoBox type="green">
        <ol v-mathjax>
          ...
          <li>Mit den <strong>restlichen Gleichungen</strong> verfährt man für die Variable $x_2, x_3, ...$</li>
          <li>Man löst die Gleichung der <strong>Stufenform</strong> schrittweise nach $x_n, x_{n-1}, …, x_1$ auf.</li>
        </ol>
      </InfoBox>
    </Subsection>
  ...
  <ContentSection title="Unterbestimmtes LGS">
    <InfoBox type="green">
      ...
      <p v-mathjax>
        So ein LGS ist niemals eindeutig Lösbar, sondern hat in der Regel <strong>unendlich viele Lösungen</strong>.
      </p>
    </InfoBox>
    <Subsection title="Beispiel">
      <MathDisplay>
