...
<template>
  <ContentSection title="Normalverteilung und Gaußsche Glockenfunktion">
    <InfoBox color="green">
      <p v-mathjax>
        Eine Zufallsgröße $X$ heißt <strong>normalverteilt </strong>mit den Parametern $\mu$ (Erwartungswert) und
      ...
      <p v-mathjax>
        Man sagt kurz: $X$ ist $N_{\mu;\sigma}$-verteilt. Die Normalverteilung ist eine <strong>stetige </strong>Verteilung.
      </p>
    </InfoBox>
    <InfoBox color="green">
      <p v-mathjax>
    ...
    <InfoBox color="green">
      <p v-mathjax>
        $\varphi_{\mu;\sigma}$ hat die Extremstelle $\mu$ und die Wendestellen $\mu \pm \sigma$ und ist die <strong>Dichtefunktion</strong>
  ...
  <ContentSection title="μ und σ aus gegebenen Daten ermitteln">
    <InfoBox color="green">
      <p v-mathjax>
        Gemessene Daten können häufig durch eine Normalverteilung mit Mittelwert $\mu$ und Standardabweichung $\sigma$
        modelliert werden.
  ...
  <ContentSection title="Umkehrung der Normalverteilung">
    <InfoBox color="green">
      <p v-mathjax>
        Für eine $N_{\mu;\sigma}$-verteilte Zufallsgröße $X$ lässt sich für eine vorgegebene Wahrscheinlichkeit $p$
    ...
    <Subsection title="Beispiel">
      <MultiColumnLayout :columns=2 image-layout>
        ...
        <template #col-2>
          <ClickableImage src="/images/Graph_InvNormal.png" alt="Graph_InvNormal.png"/>
        </template>
      </MultiColumnLayout>
    </Subsection>
  </ContentSection>
  ...
  <ContentSection title="Normalverteilung zur Annäherung einer diskreten Zufallsgröße">
    <InfoBox color="green">
      <p v-mathjax>
        Nutzt man die Normalverteilung um die Wahrscheinlichkeit für eine diskrete Zufallsgröße näherungsweise zu
    ...
    <Subsection title="Beispiel">
      <MultiColumnLayout :columns=2 image-layout>
        ...
        <template #col-2>
          <ClickableImage src="/images/Graph_Diskrete-Näherung.png" alt="Graph_Diskrete-Näherung.png"/>
        </template>
      </MultiColumnLayout>
    </Subsection>
  </ContentSection>
  ...
  <ContentSection title="Sigma-Regeln">
    <MultiColumnLayout :columns=2 image-layout>
      ...
      <template #col-2>
        <ClickableImage src="/images/Graph_Sigma-Rules.png" alt="Graph_Sigma-Rules.png"/>
      </template>
    </MultiColumnLayout>
  </ContentSection>
</template>
