...
<template>
  <ContentSection title="Grundbegriffe der Wahrscheinlichkeitsrechnung">
    <MultiColumnLayout :columns=2 image-layout :image-width=75>
      ...
      <template #col-2>
        <ClickableImage src="/images/Glücksrad.png" alt="Glücksrad.png"/>
      </template>
    </MultiColumnLayout>
    ...
    <Subsection title="Baumdiagramm">
      <MultiColumnLayout :columns=1 image-layout :image-width=75>
        <template #col-1>
          <ClickableImage src="/images/Baumdiagramm.png" alt="Baumdiagramm.png"/>
        </template>
      </MultiColumnLayout>
    </Subsection>
  ...
  <ContentSection title="Ziehen mit Zurücklegen">
    <InfoBox color="green">
      <p v-mathjax>
        Werden aus einer Urne mit $n$ verschiedene Kugeln, $k$ Stück herausgezogen, nach jedem Zug wieder zurückgelegt
  ...
  <ContentSection title="Ziehen ohne Zurücklegen">
    ...
    <Subsection title="Beispiel">
      <p v-mathjax>
        Ein Wettrennen hat 8 Teilnehmer. Für die schnellsten $3$ gibt es Preise. Wie viele Möglichkeiten gibt es, die
        Preise zu vergeben?
      </p>
      <p v-mathjax>
        <strong>Lösung:</strong>
  ...
  <ContentSection title="Ziehen mit einem Griff">
    <InfoBox color="green">
      <p v-mathjax>
        Werden aus einer Urne mit $n$ verschiedenen Kugeln, $k$ Stück mit einem Griff (gleichzeitig) herausgezogen, so
    ...
    <Subsection title="Beispiel ">
      <p v-mathjax>
        Ein Verein hat $10$ Mitglieder. Eine Mannschaft besteht aus $4$ Spielern. Wie viele mögliche Mannschaften hat
        der
        Verein?
      </p>
      <p v-mathjax>
      ...
      <InfoBox color="blue">
        <p v-mathjax>
          Ein Trick zum berechnen per Hand ist es, die $k$ größten Zahlen aus $n!$ miteinander zu multiplizieren und
          durch
          $k!$ zu teilen.
          In dem Beispiel oben kommt man dadurch schnell auf den letzten Term mit je $4$ Faktoren im Zähler und Nenner.
  ...
  <ContentSection title="Erwartungswert, Varianz und Standardabweichung">
    <InfoBox color="green">
      <p v-mathjax>
        Für eine Zufallsvariable $X$, die die Werte $x_1, x_2,..., x_n$ annehmen kann, definiert man den <strong>Erwartungswert </strong>$\mu$
  ...
  <ContentSection title="Bedingte Wahrscheinlichkeit">
    <InfoBox color="green">
      <p v-mathjax>
        Für zwei Ereignisse $A$ und $B$ mit $P(A) \neq 0$ ist die <strong>bedingte Wahrscheinlichkeit</strong>, die
  ...
  <ContentSection title="Stochastische Unabhängigkeit">
    ...
    <Subsection title="Beispiel">
      <p v-mathjax>
        In einem Betrieb hat 570 Mitarbeiter. Davon fahren $\frac 23$ mit einem Pkw zur Arbeit. Von den 190 auswärtigen
  ...
  <ContentSection title="Bernoulli-Experiment und Bernoulli-Kette">
    <InfoBox color="green">
      ...
      <p v-mathjax>
        Wenn man ein Bernoulli-Experiment $n$-mal wiederholt, sodass die Durchführungen voneinander unabhängig sind, so
        spricht man von einer <strong>Bernoulli-Kette</strong> der Länge $n$.
      </p>
    </InfoBox>
    <Subsection title="Beispiel">
      <p v-mathjax>
        5-mal eine Münze werfen ist eine Bernoulli-Kette der Länge 5, da es genau zwei Ergebnisse gibt (Kopf oder Zahl)
  ...
  <ContentSection title="Die Formel von Bernoulli">
    <InfoBox color="green">
      <p v-mathjax>
        Für eine Bernoulli-Kette der Länge $n$ und Trefferwahrscheinlichkeit $p$ gilt für die Anzahl an Treffern $k$:
      </p>
      <MathDisplay>
        P_p^k(X=k) =
        \binom nk
  ...
  <ContentSection title="Zweiseitiger Hypothesentest">
    ...
    <InfoBox color="green">
      ...
      <p v-mathjax>
        ...
        Die Nullhypothese wird angenommen, wenn mindestens 18 und höchstens 32 mal Kopf geworfen wird (Münze ist in
        Ordnung).
      </p>
      <p v-mathjax>
        <strong>Irrtumswahrscheinlichkeit</strong>:<strong>
      </strong>Die Wahrscheinlichkeit, dass die man denkt, dass die Münze verbogen ist, obwohl sie in Ordnung ist. Sie
        beträgt:
      </p>
      <MathDisplay>
        \alpha =
  ...
  <ContentSection title="Einseitiger Hypothesentest">
    ...
    <MultiColumnLayout :columns=2>
      <template #col-1>
        <Subsection title="Linksseitiger Test">
          ...
          <p v-mathjax>
            <strong>Ablehnungsbereich:</strong> $A=\{0, 1, .., g\}$, wobei $g$ die größte Natürliche Zahl mit
      ...
      <template #col-2>
        <Subsection title="Rechtsseitiger Test">
          ...
          <p v-mathjax>
            <strong>Ablehnungsbereich:</strong> $A = \{g, g+1, …, n\}$, wobei $g$ die kleinste natürliche Zahl mit
            $P^n_{p_0}(X \geq g) =
    ...
    <MultiColumnLayout :columns=2 image-layout :image-columns=[1,2]>
      <template #col-1>
        <ClickableImage src="/images/Graph_Linksseitiger-Hypothesentest.png"
                        alt="Graph_Linksseitiger-Hypothesentest.png"/>
      </template>
      <template #col-2>
        <ClickableImage src="/images/Graph_Rechtsseitiger-Hypothesentest.png"
                        alt="Graph_Rechtsseitiger-Hypothesentest.png"/>
      </template>
    </MultiColumnLayout>
  </ContentSection>
  ...
  <ContentSection title="Fehler 1. und 2. Art">
    <InfoBox color="green">
      ...
      <ul v-mathjax style="padding-top: 1rem">
        ...
        <li>
          Die Wahrscheinlichkeit für den Fehler 2. Art ist $\beta$ und lässt sich nur berechnen, wenn die echte
    ...
    <Subsection title="Beispiel">
      <p v-mathjax>
        Angenommen, eine Firma testet, ob eine neue Batterie eine durchschnittliche Laufzeit von <strong>mindestens 10
        Stunden</strong> hat.
      </p>
      <p v-mathjax>
      ...
      <p v-mathjax>
        ...
        Der Test ergibt, dass die Laufzeit <strong>weniger als</strong> 10 Stunden beträgt ($H_0$ wird angenommen),
  ...
  <ContentSection title="Wahl der Nullhypothese">
    <InfoBox color="green">
      <p v-mathjax>
        Bei einem Hypothesentest wird der Fehler, dass die Nullhypothese $H_0$ aufgrund des Stichprobenergebnisses
        fälschlicherweise verworfen wird, kontrolliert
      </p>
      <p v-mathjax>
        Seine Wahrscheinlichkeit ist stets<strong> höchstens</strong> so groß wie das Signifikanzniveau $\hat\alpha$.
      </p>
    ...
    <Subsection title="Beispiel">
      ...
      <p v-mathjax>
        ...
        Der Autoclub möchte zeigen, dass sich mehr als 85% angurten. Daher wählt man $H_1: p > 0{,}85$. Daraus folgt
        $H_0:
        p \leq 0{,}85$.
      </p>
      <p v-mathjax>
        <strong>Dadurch ist die 1. Faustregel auch erfüllt:</strong><br>
        Der schlimmere Fehler ist der 1. Art, da der Autoclub der Zeitung vorwirft falsche Informationen zu verbreiten.
    ...
    <InfoBox color="blue">
      <p v-mathjax>
        Die 1. Faustregel folgt meist aus der 2. Faustregel. Daher ist es oft am einfachsten, nach der 2. Faustregel zu
