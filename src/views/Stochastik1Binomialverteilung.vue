    ...
    <MultiColumnLayout :columns=2>
      <template #col-1>
        <Subsection title="Linksseitiger Test">
          ...
          <p v-mathjax>
            <strong>Gegenhypothese: </strong>$H_1: p < p_0$ </p>
              <p v-mathjax>
  ...
  <ContentSection title="Fehler 1. und 2. Art">
    ...
    <Subsection title="Berechnen von $\mathbf{\alpha}$ und $\mathbf{\beta}$">
      <MathDisplay>
        ...
        H_0 = p \geq 0{,}6 \quad
        H_1 = p < 0{,}6 \\ {}\\ P^{50}_{0{,}6}(X \leq g) \leq 5\% \\ \Rightarrow g=23 \\{}\\ \textsf{Um β zu berechnen
          brauchen wir die tatsächliche}\\ \textsf{Wahrscheinlichkeit. Ich gebe sie hier als } p=0{,}55 \textsf{ vor.}
          \\{}\\ \begin{align*} \alpha &=P^{50}_{0{,}6}(X \leq 23) \approx 0{,}0314 \\ \beta
          &=P^{50}_{\color{red}0{,}55} (X \ {\color{red}>} \ 23) = 1 - P^{50}_{0{,}55}(X \leq 23) \approx 0{,}872
          \end{align*}
          \end{array}
      </MathDisplay>
    </Subsection>
