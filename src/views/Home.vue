...
<template>
    ...
    <ContentSection title="Sonstiges">
        <Subsection title="Weiter Zusammenfassungen">
            <p>
                <strong>Geo: </strong><a href="https://geo.officeryoda.de" rel="noopener" target="_blank">geo.officeryoda.de</a><br>
                <strong>Deutsch: </strong><a href="https://deutsch.officeryoda.de" rel="noopener" target="_blank">deutsch.officeryoda.de</a><br>
            ...
            <template #col-1>
                <Subsection title="Kontakt">
                    <p>
                        ...
                        <strong>GitHub: </strong><a href="https://github.com/OfficerYoda/mathe-zusammenfassung-vue"
                                                    rel="noopener"
